...
@section('breadcrump')
          <h1>
            Nilai Siswa "{{$siswa->kelas_siswa}}" - "{{$siswa->nama_siswa}}"
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Nilai Siswa "{{$siswa->kelas_siswa}}" - "{{$siswa->nama_siswa}}"</li>           
          </ol>
@stop
@section('content')
          <div class="row">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <div class="box-header">               
                    <form id="formKelasMapel" class="form-horizontal" role="form" method="POST" action="{{ route('siswa.nilai')}}");>
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class="form-group">
                      <label class="col-md-4 control-label">Pilih Mata Pelajaran</label>
                      <div class="col-md-4">  
                        <select class="form-control " name="mapel_terpilih" style="font-size: 14px; text-align: left;">
