          ...
          <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-danger">
                  ...
                  <form id="formPengumumanTambah" class="form-horizontal" role="form" method="POST" action="{{ url('admin/pengumuman/tambah') }}" >
                  ...
                  <div class="col-md-12" style="margin-left:8%;">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <textarea class="form-control" name="deskripsi" rows="5"  placeholder="Deskripsi Pengumuman"></textarea>                              
                        <small class="help-block"></small>
                    </div>
